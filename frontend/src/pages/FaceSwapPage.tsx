...
import { Wand2, ScanFace } from 'lucide-react'
import ImageUploader from '@/components/ImageUploader'
import DetectedFaces from '@/components/DetectedFaces'
import ProcessingStatus from '@/components/ProcessingStatus'
import ResultViewer from '@/components/ResultViewer'
import { useAppStore } from '@/store/useAppStore'
import { useDetectFaces, useFaceSwap } from '@/hooks/useFaceSwap'
import { useTranslation } from '@/i18n/useTranslation'

export default function FaceSwapPage() {
  const { originalImage, detectedFaces, targetFaces, status } = useAppStore()
